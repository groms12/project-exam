$(document).ready(function () {
    ...
    document.addEventListener('keydown', function (e) {
        if (e.keyCode === 27) {
            if (modalFree.hasClass('modal--free--visible'))  
                modalFree.toggleClass('modal--free--visible');
            if (modalCall.hasClass('modal--call--visible'))  
            modalCall.toggleClass('modal--call--visible');
        } 
    });
...
$(document).ready(function(){
        $(".header__menu_1").on("click","a", function (event) {
            event.preventDefault();
            var id  = $(this).attr('href'),
                top = $(id).offset().top;
            $('body,html').animate({scrollTop: top}, 1500);
...
$(document).ready(function(){
    $(".footer__menu__list").on("click","a", function (event) {
        event.preventDefault();
        var id = $(this).attr('href'),
        top = $(id).offset().top;
        $('body,html').animate({scrollTop: top}, 1500);
    ...
    $('.section__free__form').validate({
      ...
      $('.modal__form_1').validate({
        ...
        $("#check_01").click(function(){
            $(".label_01").toggleClass("section__cards__text__radio--active");
            $(".label_02").removeClass("section__cards__text__radio--active");
            $(".label_03").removeClass("section__cards__text__radio--active");
            $(".label_04").removeClass("section__cards__text__radio--active");
            $(".label_05").removeClass("section__cards__text__radio--active");
            return false;
        });
        $("#check_02").click(function(){
            $(".label_02").toggleClass("section__cards__text__radio--active");
            $(".label_01").removeClass("section__cards__text__radio--active");
            $(".label_03").removeClass("section__cards__text__radio--active");
            $(".label_04").removeClass("section__cards__text__radio--active");
            $(".label_05").removeClass("section__cards__text__radio--active");
            return false;
        ...
        $("#check_03").click(function(){
            $(".label_03").toggleClass("section__cards__text__radio--active");
            $(".label_02").removeClass("section__cards__text__radio--active");
            $(".label_01").removeClass("section__cards__text__radio--active");
            $(".label_04").removeClass("section__cards__text__radio--active");
            $(".label_05").removeClass("section__cards__text__radio--active");
        ...
        $("#check_04").click(function(){
            $(".label_04").toggleClass("section__cards__text__radio--active");
            $(".label_02").removeClass("section__cards__text__radio--active");
            $(".label_03").removeClass("section__cards__text__radio--active");
            $(".label_01").removeClass("section__cards__text__radio--active");
            $(".label_05").removeClass("section__cards__text__radio--active");
        ...
        $("#check_05").click(function(){
            $(".label_05").toggleClass("section__cards__text__radio--active");
            $(".label_02").removeClass("section__cards__text__radio--active");
            $(".label_03").removeClass("section__cards__text__radio--active");
            $(".label_04").removeClass("section__cards__text__radio--active");
            $(".label_01").removeClass("section__cards__text__radio--active");
